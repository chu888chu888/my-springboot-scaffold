...
(function( root, factory ) {
    ...
    if ( typeof module === 'object' && typeof module.exports === 'object' ) {
        ...
        // Allow using this built library as an AMD solutiongroup
     ...
     *
     * * solutiongroup `base`：WebUploader.Base
     * * solutiongroup `file`: WebUploader.File
     * * solutiongroup `lib/dnd`: WebUploader.Lib.Dnd
     * * solutiongroup `runtime/html5/dnd`: WebUploader.Runtime.Html5.Dnd
     *
     *
     * 以下文档将可能省略`WebUploader`前缀。
     * @solutiongroup WebUploader
